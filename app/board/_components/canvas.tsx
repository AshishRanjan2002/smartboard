...
const Canvas = ({
  ...
  const startMultiSelection = useCallback((
    ...
    if (
      Math.abs(current.x - origin.x) + Math.abs(current.y - origin.y) > 5    //>5 to ensure that user presses and drags some distance.
    ) {
      setCanvasState({
        mode: CanvasMode.SelectionNet,
        origin,
